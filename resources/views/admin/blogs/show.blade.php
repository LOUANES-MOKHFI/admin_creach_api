...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ عرض مقالة</span>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <h5> اسم مدير الروضة : <span class="badge badge-success">{{$blog->creche->name}}</span></h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    <h4 class="form-section text-danger"><i class="ft-home"></i>معلومات المقالة</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <h5>اسم المقالة : <span class="badge badge-danger">{{$blog->title}}</span> </h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
