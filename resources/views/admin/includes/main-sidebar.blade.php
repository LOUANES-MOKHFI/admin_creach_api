    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('admin.creches')}}">الروضات</a></li>
                    <li><a class="slide-item" href="{{route('admin.vendeurs')}}">البائعين</a></li>
                    <li><a class="slide-item" href="{{route('admin.users')}}">المستخدمين</a></li>
                </ul>
            </li>
            <li class="slide">
