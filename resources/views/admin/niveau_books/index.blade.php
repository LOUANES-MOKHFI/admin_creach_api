...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ مستويات الكتب</span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        <a href="{{route('admin.niveau_books.create')}}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp; أضف مستوى
                        </a>
                            ...
                            @isset($niveaux)
                                @foreach($niveaux as $key=>$niveau)
                                    <tr>
                                        ...
                                        <td>{{$niveau->age}}</td>
                                        <td>
                                        <a href="{{route('admin.niveau_books.edit',$niveau->uuid)}}"class="btn btn-warning waves-effect waves-light" title="{{__('admin/patients.edit')}}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="{{route('admin.niveau_books.delete',$niveau->uuid)}}" class="btn btn-danger waves-effect waves-light" title="{{__('admin/patients.delete')}}">
