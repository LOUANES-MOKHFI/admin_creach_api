...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المساهمات</span>
            </div>
        </div>
                            ...
                            @isset($blogs)
                                @foreach($blogs as $key=>$blog)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.contributions.show',$blog->uuid)}}" class="btn btn-info waves-effect waves-light" title="عرض">
                                                <i class="fa fa-eye"></i>
                                            </a>
