...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة البائعين</span>
            </div>
        </div>
                            ...
                            @isset($vendeurs)
                                @foreach($vendeurs as $key=>$vendeur)
                                    <tr>
                                        ...
                                        <a href="{{route('admin.vendeurs.edit',$vendeur->uuid)}}"class="btn btn-warning waves-effect waves-light" title="تعديل">
