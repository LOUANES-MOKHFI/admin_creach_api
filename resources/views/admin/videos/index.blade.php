...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفيديوهات</span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        <a href="{{route('admin.videos.create')}}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                            ...
                            @isset($videos)
                                @foreach($videos as $key=>$video)
                                    <tr>
                                        ...
                                        <td>{{$video->domaine}}</td>
                                        <td><a href="{{$video->link}}">عرض الفيديو</a></td>
                                        <td>
                                        <a href="{{route('admin.videos.edit',$video->uuid)}}"class="btn btn-warning waves-effect waves-light" title="تعديل">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="{{route('admin.videos.delete',$video->uuid)}}" class="btn btn-danger waves-effect waves-light" title="حذف">
