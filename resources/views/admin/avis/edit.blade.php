...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل رأي</span>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form" action="{{route('admin.avis.update',$avi->id)}}"
                      method="POST"
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$avi->name}}" id="name"
                                           class="form-control"
                                           placeholder="  "
                                           name="name">
                                    @error("name")
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="wilaya" class="form-control" id="">
                                        ...
                                        @foreach($wilayas as $wilaya)
                                            <option value="{{$wilaya->name}}" {{$wilaya->name == $avi->wilaya ? 'selected' : ''}}>{{$wilaya->name}}</option>
                                        @endforeach
                                        @endisset
                                    </select>
                                    @error("wilaya")
