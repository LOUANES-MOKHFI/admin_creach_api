...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ أقسام الاستشارات</span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        <a href="{{route('admin.categories_faqs.create')}}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                            ...
                            @isset($categories)
                                @foreach($categories as $key=>$category)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{route('admin.categories_faqs.edit',$category->uuid)}}"class="btn btn-warning waves-effect waves-light" title="تعديل">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="{{route('admin.categories_faqs.delete',$category->uuid)}}" class="btn btn-danger waves-effect waves-light" title="حذف">
