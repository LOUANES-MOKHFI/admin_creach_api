...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الرسائل</span>
            </div>
        </div>
                            ...
                            @isset($messages)
                                @foreach($messages as $key=>$message)
                                    <tr>
                                        ...
                                        <td>{{$message->email}}</td>
                                        <td>
                                        <a href="{{route('admin.contacts.show',$message->uuid)}}"class="btn btn-info waves-effect waves-light" title="عرض">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{route('admin.contacts.delete',$message->uuid)}}" class="btn btn-danger waves-effect waves-light" title="حذف">
