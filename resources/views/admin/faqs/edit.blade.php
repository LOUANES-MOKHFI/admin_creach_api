...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل استشارة</span>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form" action="{{route('admin.faqs.update',$faq->uuid)}}"
                      method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" id="" required class="form-control">
                                        ...
                                        @foreach($categories as $category)
                                            <option {{$faq->category_id == $category->id ? 'selected' : ''}} value="{{$category->id}}">{{$category->name}}</option>
                                        @endforeach
                                        @endisset
                                    </select>
                                    @error("category")
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="tinymce" name="question" cols="90" rows="10">{{$faq->question}}</textarea>
                                    @error("question")
                                    <span class="text-danger"> {{$message}}  </span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="tinymce" name="response" cols="90" rows="10"> {{$faq->response}} </textarea>
                                    @error("response")
                                    <span class="text-danger"> {{$message}}  </span>
                                    @enderror
                                </div>
