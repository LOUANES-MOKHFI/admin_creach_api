...
@section('content')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الوظائف المطلوبة في الروضات</span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        <a href="{{route('admin.settings.emplois.create')}}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp; أضف الوظيفة 
                        </a>
                </div>
                <div class="card-body">
                            ...
                            @isset($emplois)
                                @foreach($emplois as $key=>$emploi)
                                    <tr>
                                        ...
                                        <td>{{$emploi->name}}</td>
                                        <td>
                                            <a href="{{route('admin.settings.emplois.edit',$emploi->uuid)}}"class="btn btn-warning waves-effect waves-light" title="تعديل">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{route('admin.settings.emplois.delete',$emploi->uuid)}}" class="btn btn-danger waves-effect waves-light" title="حذف">
